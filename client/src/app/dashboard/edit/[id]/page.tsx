                ...
                <div className="lg:col-span-1">
                    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
                        ...
                        <div className="mt-8 pt-6 border-t border-slate-100">
                            {qrInfo?.url_link_id ? (
                                <Link
                                    href={`/dashboard/urlmd/${qrInfo.url_link_id}`}
                                    className="mb-4 w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg border border-indigo-200 text-indigo-700 bg-indigo-50 hover:bg-indigo-100 text-sm font-semibold"
                                >
                                    Manage linked URLMD short link
                                </Link>
                            ) : null}
