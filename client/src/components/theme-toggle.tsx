...
export function ThemeToggle() {
    ...
    return (
        <button
            ...
            className="p-2 rounded-lg bg-secondary text-secondary-foreground hover:bg-accent transition-colors relative w-10 h-10 flex items-center justify-center border border-border"
